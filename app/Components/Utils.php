...
class Utils
{
    ...
    //幸运用户的URL
    const LUCKUSER_URL = (self::DEBUG_FLAG == false) ? "http://wg.gowithtommy.com/luckUser" : "http://mjttfwh.isart.me/luckUser";
    const RICHBUY_URL = (self::DEBUG_FLAG == false) ? "http://wg.gowithtommy.com/richBuy" : "http://mjttfwh.isart.me/richBuy";
